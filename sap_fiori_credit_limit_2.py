...
# INPUTS
# ==========
EXCEL_PATH = r"C:\Users\junio\Downloads\Itens (71).xlsx"
    ...
    with sync_playwright() as p:
        ...
        for idx, row in df.iterrows():
            ...
            try:
                ...
                # tenta voltar pro filtro para seguir
                try:
                    force_back_to_listreport(page, app_url, attempts=5)
                except Exception:
                    pass
